...
class CostRegNet(nn.Module):
    def __init__(self, in_channels, base_channels):
        ...
        self.conv0_0 = Conv3d(in_channels, base_channels, padding=1)
        self.conv0_12 = Conv3d(in_channels + 2, base_channels, padding=1)
    ...
    def forward(self, x, i):
        if i == 0:
            conv0 = self.conv0_0(x)
        else:
            conv0 = self.conv0_12(x)
...
def get_depth_range_samples(cur_depth, ndepth, depth_inteval_pixel, device, dtype, shape,
    ...
    if cur_depth.dim() == 2:
        ...
        depth_range_samples, stage_interval = get_cur_depth_range_samples(cur_depth, ndepth, depth_inteval_pixel, shape, max_depth, min_depth)
