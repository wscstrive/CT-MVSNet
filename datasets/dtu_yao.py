...
class MVSDataset(Dataset):
    ...
    def read_src_depth(self, filename, src_s1, src_s2, src_s3):
        ...
        h, w = depth_lr.shape
        src_s1.append(cv2.resize(depth_lr, (w//4, h//4), interpolation=cv2.INTER_NEAREST))
        src_s2.append(cv2.resize(depth_lr, (w//2, h//2), interpolation=cv2.INTER_NEAREST))
        src_s3.append(depth_lr)
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            if i == 0:  # reference view
                ...
                src_s1, src_s2, src_s3 = self.read_src_depth(depth_filename_hr, src_s1, src_s2, src_s3)
